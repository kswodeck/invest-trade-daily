...
def cumulative_rows(positions: list[dict], first_row: int) -> tuple[list[list[Any]], list[tuple[int, int, str]]]:
    ...
    rows: list[list[Any]] = [
        ...
        [f'=CONCATENATE("Ideas tracked: ",{n_all},"   ·   closed: ",{n_closed},'
         f'"   ·   open: ",{n_open},"   ·   priced: ",COUNT({pct}))'],
        [""],
    ...
    formats: list[tuple[int, int, str]] = [
        (5, 1, "pct"), (5, 2, "pct"), (5, 3, "pct"),
        (6, 1, "pct"), (6, 2, "pct"), (6, 3, "pct"),
        (8, 1, "rate"),
        (11, 1, "pct"), (11, 2, "pct"),
    ]
        ...
        reqs.append({
            "repeatCell": {
                ...
                "cell": {"userEnteredFormat": {
                    ...
                    "textFormat": {"bold": kind == "pct" and offset in (5, 6)},
                }},
